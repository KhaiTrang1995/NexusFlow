...
| — | [Samples](samples/README.md) | Nine reference applications |
...
FlowX is in **design phase**. This repository currently contains the specification
that the implementation must satisfy. The specification is the contract: code that
contradicts it is a bug in the code, or an ADR that has not been written yet.

See [20-Roadmap](docs/20-Roadmap.md) for the delivery plan and
[CONTRIBUTING](CONTRIBUTING.md) for how to propose a change.
