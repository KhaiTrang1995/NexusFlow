...
| **P9** Hardening and 1.0 | **WP-130 … WP-139** · *WP-130 claimed 2026-08-14: the V5 cold-start harness — a criterion with no number is not a criterion* | all of them | The roadmap table only | **Invented.** The *targets* are unambiguous (V1–V8, Q1–Q8, B1–B13); there is no design. Note eight of the nine samples are a `README.md` and nothing else |
