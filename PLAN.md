...
| **V5** | cold start ≤ 200 ms, NativeAOT | **met on advisory hardware, and measured at last** — WP-130's harness AOT-publishes the reference sample and times 30 starts: **p50 63.0 ms, p99 102.2 ms** to first flow response, binary 18.0 MiB, RSS 35.4 MiB ([V5-cold-start.md](docs/benchmarks/V5-cold-start.md), shared-container caveats argued there). Not gated: no CI job compares the number. *This cell said "unreported; nothing times it"* | a CI gate; a cloud-container measurement |
