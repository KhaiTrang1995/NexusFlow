...
/// <c>FLOWX1056</c>, so an author who declared <c>Validate</c> and got nothing is told, rather
...
public static class ValidationRuleReader
{
    ...
    /// cannot fire, and one that would let a contract satisfy <c>FLOWX1056</c> while validating
    /// nothing.
    /// </para>
    /// </remarks>
