...
public static class FlowAnalyzer
{
    ...
    private static void ReportPolicyConflicts(StepModel step, ChainLink link, List<Diagnostic> diagnostics)
    {
        ...
        // FLOWX1055 — a Validate whose contract declares nothing to check. Judged from the
    ...
    /// <summary>The policy kind whose rules live on the contract rather than in the call — FLOWX1055.</summary>
