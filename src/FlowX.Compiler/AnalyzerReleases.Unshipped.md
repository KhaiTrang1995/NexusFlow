...
FLOWX1031 | FlowX | Warning | Suspension construct is declared but not honoured by the compiler; narrowed at WP-63 to Delay and OnTimeout, which still reach no plan, no dispatcher and no manifest. AwaitSignal is honoured and is no longer reported. Deleted when the timer half of WP-63 lands. [Documentation](https://github.com/votrongdao/FlowX/blob/master/docs/diagnostics/FLOWX1031.md)
