...
[FLOWX1032](FLOWX1032.md) is a warning because the runtime will eventually execute the
policies it reports: the source is ahead of the platform, not wrong. This rule is
