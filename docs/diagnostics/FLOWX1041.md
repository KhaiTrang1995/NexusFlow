...
([ADR-0047](../adr/ADR-0047-a-change-trigger-observes-the-outbox.md)). Two things stop a flow
being registered.
...
([ADR-0047](../adr/ADR-0047-a-change-trigger-observes-the-outbox.md) decision 3). It is not this
rule, and the pod does not become ready rather than the build failing.

## Related

- [ADR-0047](../adr/ADR-0047-a-change-trigger-observes-the-outbox.md) — what a change trigger
