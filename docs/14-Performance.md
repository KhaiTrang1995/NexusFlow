...
| B12 | Build overhead vs identical non-FlowX code | **+46.5 %** at 50 flows · **+67.1 %** [+61.9, +73.6] at 200 — [B12-scale.md §8](benchmarks/B12-scale.md). *This row carried the superseded **+77 %** until 2026-07-31; WP-43 re-measured after the duplicated-bind fix* | **≤ 800,000 B/flow · ≤ 160,000 B/capability** | **MET**, against the criterion [ADR-0014](adr/ADR-0014-derived-error-catalogue-vs-build-budget.md) re-expressed on 2026-08-10: 729,311 and 140,252 at 25 flows, 726,564 and 138,657 at 50. `check-generator-cost.py` fails on a breached ceiling. The percentages in this row are what the superseded ratio measured, and the `scale-overhead` job that measures it stays advisory |
