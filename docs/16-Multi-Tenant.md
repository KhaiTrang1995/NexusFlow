...
> [ADR-0043](adr/ADR-0043-a-tenant-is-resolved-at-admission.md) records the decisions,
...
[ADR-0043 §2.1–2.2](adr/ADR-0043-a-tenant-is-resolved-at-admission.md): it takes the
...
> instance. See [ADR-0043 §2.6](adr/ADR-0043-a-tenant-is-resolved-at-admission.md).
