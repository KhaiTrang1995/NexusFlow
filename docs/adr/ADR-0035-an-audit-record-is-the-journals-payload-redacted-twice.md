# ADR-0035: An audit record carries the journal's payload, redacted a second time by `redact`
...
degrade. [FLOWX1032](../diagnostics/FLOWX1032.md)'s third remedy is explicit that a flow whose
...
[ADR-0036](ADR-0036-a-cache-is-a-plugin-store-keyed-by-the-redacted-input.md) ·
