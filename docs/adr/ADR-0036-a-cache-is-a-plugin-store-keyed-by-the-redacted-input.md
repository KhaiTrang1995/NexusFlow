# ADR-0036: A cache is a plugin store keyed by the payload the journal would have written, and it declines anything that came out redacted
...
it. This is the opposite of what [ADR-0035](ADR-0035-an-audit-record-is-the-journals-payload-redacted-twice.md)
...
[ADR-0035](ADR-0035-an-audit-record-is-the-journals-payload-redacted-twice.md)
