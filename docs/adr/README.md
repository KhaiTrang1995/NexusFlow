...
| [0035](ADR-0035-an-audit-record-is-the-journals-payload-redacted-twice.md) | *(number claimed — stage 7's `Audit`)* | **Proposed** | to be written |
| [0036](ADR-0036-a-cache-is-a-plugin-store-keyed-by-the-redacted-input.md) | *(number claimed — stage 5's `Cache`)* | **Proposed** | to be written |
