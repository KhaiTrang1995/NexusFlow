...
1. **A broker owns its deliveries; a feed owns nothing.** `IBusConsumer` can acknowledge because
   ...
   ([ADR-0047](ADR-0047-a-change-trigger-observes-the-outbox.md) decision 2). A change
...
- **Mark the outbox row** — [ADR-0047](ADR-0047-a-change-trigger-observes-the-outbox.md) force 2:
