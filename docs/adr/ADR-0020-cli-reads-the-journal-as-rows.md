...
green fitness function, `flowx replay` reads a journal, and one of the two has to give. [22-CLI §8](../22-CLI.md#8-flowx-replay-against-the-fitness-function--a-finding-not-a-decision)
