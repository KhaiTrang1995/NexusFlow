...
public sealed class GeneratedValidationTests
{
    ...
    /// </remarks>
    [Fact]
    public void ReportsFLOWX1055WhenTheContractDeclaresNoRule()
    {
        ...
        run.Ids.ShouldContain("FLOWX1055", run.Describe());
    ...
    /// </remarks>
    [Fact]
    public void DoesNotReportFLOWX1055WhenTheContractIsAnnotated() =>
        GeneratorHarness.Run(Preamble).Ids.ShouldNotContain("FLOWX1055");

    /// <summary>A step with no <c>Validate</c> is not reported, however bare its contract.</summary>
    [Fact]
    public void DoesNotReportFLOWX1055WithoutAValidate() =>
        GeneratorHarness.Run(FlowPlanGeneratorTests.WithFlow("""
            ...
            """)).Ids.ShouldNotContain("FLOWX1055");
